...
function addGamesToPage(games) {
    ...
    for (let game of games) {
        ...
        // add the class game-card to the div list
...
const fundedGamesMsg = unfundedGamesCount == 0 ? `We've met our goal for all our games! 
Thank you! Please continue to support us!` : `We have ${fundedGamesCount.toLocaleString('en-US')}
 funded! Thank you! We still have ${unfundedGamesCount.toLocaleString('en-US')} games that still 
 need funding, please consider supporting us!`;

// create a new DOM element containing the template string and append it to the description container
const descriptionElement = document.createElement("p");
descriptionElement.innerHTML = fundedGamesMsg;
